...
from caw.watermarks import VersionCheckWatermark
...
def main():
    ...
    args.output_path = f"math_version_frq{args.frq}"
    ...
    injector = BaseInjector(trajectories=trajectories_with_triggers, wmk=[VersionCheckWatermark()])
