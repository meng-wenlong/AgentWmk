...
from caw.watermarks import CheckNetworkWatermark
...
def main():
    ...
    args.output_path = f"sqa_network_frq{args.frq}"
    ...
    injector = BaseInjector(trajectories=trajectories_with_triggers, wmk=[CheckNetworkWatermark()])
