...
from caw.watermarks import FileCreateCheckWatermark
...
def main():
    ...
    args.output_path = f"swe_create_frq{args.frq}"
    ...
    injector = BaseInjector(trajectories=trajectories_with_triggers, wmk=[FileCreateCheckWatermark()])
